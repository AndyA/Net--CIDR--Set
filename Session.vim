...
set shortmess=aoO
badd +231 lib/Net/CIDR/Set.pm
badd +7 t/operations.t
badd +36 lib/Net/CIDR/Set/IPv4.pm
badd +46 lib/Net/CIDR/Set/IPv6.pm
badd +19 andy/fmt.pl
badd +12 Build.PL
badd +3 bin/cidrcalc
badd +0 t/misc.t
...
exe 'vert 7resize ' . ((&columns * 85 + 85) / 170)
argglobal
...
silent! normal! zE
let s:l = 34 - ((9 * winheight(0) + 19) / 39)
